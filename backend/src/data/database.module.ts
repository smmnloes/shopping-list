...
import { BabyName } from './entities/baby-name'

export const entities = [ ShoppingList, ListItem, MealPlan, Note, User, Location, TakeoutPayment, NotificationSubscription, FileShare, BabyName ]
